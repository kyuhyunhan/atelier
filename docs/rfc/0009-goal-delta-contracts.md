...
| **G2** promote predicate | `promote_eligible.total ≤ 30`, `.by_domain.knowledge = 0` | ✅ **CLOSED 2026-07-26** (PR #78, the first live goal-workflow run) — `is_promote_eligible` narrowed to the operational lane: 830 → 23, knowledge 807 → 0; live today at 23 ≤ 30. |
